                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                ...
                                @endif
                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="{{ route('product.store') }}" class="form form-horizontal">
                                        @csrf
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-3 col-form-label">
                                                        <label for="contact-info">Foto Produk</label>
                                                    </div>
                                                    <div class="col-sm-9">
                                                    <input type="file" name="image" class="form-control dz-message">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
