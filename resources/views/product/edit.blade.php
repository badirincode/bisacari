            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Tambah Product</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Product</a>
                                    </li>
                                    
                                    </li>
                                    <li class="breadcrumb-item active"><a href="#">Tambah Product</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('product.update',$product->id) }}" class="form form-horizontal">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-3 col-form-label">
                                                        <label for="first-name">Nama Produk</label>
                                                    </div>
                                                    <div class="col-sm-9">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-3 col-form-label">
                                                        <label for="contact-info">Kode Produk</label>
                                                    </div>
                                                    <div class="col-sm-9">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-3 col-form-label">
                                                        <label for="contact-info">Harga</label>
                                                    </div>
                                                    <div class="col-sm-9">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <option {{ $kat->id == $product->kategori_id ? 'selected':'' }} value="{{ $kat->id }}">{{ $kat->name }}</option>
                                                    @endforeach
                                                    </select>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea name="desc" id="desc" cols="2" rows="2" class="form-control">{{ $product->desc }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
