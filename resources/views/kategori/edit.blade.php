                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form  method="POST" action="{{ route('kategori.update',$kategori->id) }}" class="form form-horizontal">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                     <input type="text" value="{{ $kategori->name }}" name="name" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea name="desc" id="desc" cols="2" rows="2" class="form-control">{{ $kategori->desc }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
