            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Halaman Kategori</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active">Halaman Kategori
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($kategori as $index => $r)
                                        <tr>
                                            ...
                                            <a class="btn btn-primary" href="{{ route('kategori.edit',$r->id) }}">Edit</a>
                                            @csrf
                                            @method('DELETE')
